...
nume = random.randrange(5000000000000000, 5999999999999999)
nume2 = random.randrange(4000000000000000, 4999999999999999)
nume3 = random.randrange(300000000000000, 399999999999999)
nume4 = random.randrange(6000000000000000, 6999999999999999)
...
while True:
    ...
    print('  [ 2 ] TARGETAS DE CREDITO VISA')
    print('  [ 3 ] TARGETAS DE CREDITO AMEX')
    print('  [ 4 ] TARGETAS DE CREDITO DISCOVER')
    print('  [ 5 ] GENERADOR DE BINS')
    ...
    if bi == '1':
        ...
        print(celeste)
        print(space)
        print('TARGETA DE CREDITO:',nume2)
        print('CVV :',cvv)
        print('FECHA :',data1gen(),sp,data2gen())
        print('IP :' ,data3)
        print('CPF DE LA TARGETA :',cpf)
        ...
        print(morado)
        print(space)
        print('TARGETA DE CREDITO:',nume3)
        print('CID :',cid)
        print('FECHA :',data1gen(),sp,data2gen())
        print('IP :' ,data3)
        print('CPF DE LA TARGETA :',cpf)
        ...
        print(amarillo)
        print(space)
        print('TARGETA DE CREDITO:',nume4)
        print('CCV :',cvv)
        print('FECHA :',data1gen(),sp,data2gen())
        print('IP :' ,data3)
        print('CPF DE LA TARGETA :',cpf)
